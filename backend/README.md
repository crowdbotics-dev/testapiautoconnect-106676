...
## Project Structure
    ...
    ├── testapiautoconnect_106676  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_106676`
...
2. Clone this repo and `cd testapiautoconnect_106676`
